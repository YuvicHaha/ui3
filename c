...
TabLayout.Padding=UDim.new(0,6)
    ...
    local Themes={
        Gradient={
            Bg={Color3.fromRGB(45,18,72),Color3.fromRGB(125,55,190)},
            Surface={Color3.fromRGB(25,15,42),Color3.fromRGB(58,28,82)},
            Card={Color3.fromRGB(35,20,52),Color3.fromRGB(72,32,92)},
            Button={Color3.fromRGB(91,33,182),Color3.fromRGB(196,113,245)},
            Track={Color3.fromRGB(14,9,24),Color3.fromRGB(38,18,52)},
            Trail={Color3.fromRGB(91,33,182),Color3.fromRGB(196,113,245)},
            Border=Color3.fromRGB(139,92,246),
            Text=Color3.fromRGB(245,240,255),
            Dim=Color3.fromRGB(170,150,190),
            Accent=Color3.fromRGB(196,113,245),
            Hover=Color3.fromRGB(139,92,246)
        },
        Cyberpunk={
            Bg={Color3.fromRGB(45,5,35),Color3.fromRGB(105,10,75)},
            Surface={Color3.fromRGB(28,8,30),Color3.fromRGB(58,12,48)},
            Card={Color3.fromRGB(38,12,38),Color3.fromRGB(78,18,62)},
            Button={Color3.fromRGB(255,55,165),Color3.fromRGB(0,225,255)},
            Track={Color3.fromRGB(15,7,20),Color3.fromRGB(40,10,35)},
            Trail={Color3.fromRGB(255,55,165),Color3.fromRGB(0,225,255)},
            Border=Color3.fromRGB(85,25,90),
            Text=Color3.fromRGB(235,225,245),
            Dim=Color3.fromRGB(145,125,160),
            Accent=Color3.fromRGB(0,225,255),
            Hover=Color3.fromRGB(255,55,165)
        },
        Ocean={
            Bg={Color3.fromRGB(5,35,65),Color3.fromRGB(0,150,190)},
            Surface={Color3.fromRGB(5,28,48),Color3.fromRGB(8,72,92)},
            Card={Color3.fromRGB(8,40,58),Color3.fromRGB(10,85,105)},
            Button={Color3.fromRGB(0,130,170),Color3.fromRGB(55,220,210)},
            Track={Color3.fromRGB(3,15,25),Color3.fromRGB(8,45,60)},
            Trail={Color3.fromRGB(0,150,200),Color3.fromRGB(55,220,210)},
            Border=Color3.fromRGB(25,115,135),
            Text=Color3.fromRGB(225,250,255),
            Dim=Color3.fromRGB(135,180,190),
            Accent=Color3.fromRGB(55,220,210),
            Hover=Color3.fromRGB(0,180,210)
        },
        Rose={
            Bg={Color3.fromRGB(65,10,32),Color3.fromRGB(175,40,88)},
            Surface={Color3.fromRGB(42,8,24),Color3.fromRGB(78,18,42)},
            Card={Color3.fromRGB(58,12,32),Color3.fromRGB(105,25,58)},
            Button={Color3.fromRGB(190,45,105),Color3.fromRGB(255,120,165)},
            Track={Color3.fromRGB(20,6,12),Color3.fromRGB(48,12,26)},
            Trail={Color3.fromRGB(210,55,115),Color3.fromRGB(255,130,175)},
            Border=Color3.fromRGB(125,40,72),
            Text=Color3.fromRGB(255,240,246),
            Dim=Color3.fromRGB(190,145,160),
            Accent=Color3.fromRGB(255,120,165),
            Hover=Color3.fromRGB(230,65,125)
        },
        Zombie={
            Bg={Color3.fromRGB(12,40,15),Color3.fromRGB(78,125,28)},
            Surface={Color3.fromRGB(10,27,12),Color3.fromRGB(30,52,17)},
            Card={Color3.fromRGB(18,38,15),Color3.fromRGB(48,70,20)},
            Button={Color3.fromRGB(70,125,35),Color3.fromRGB(165,190,55)},
            Track={Color3.fromRGB(6,14,7),Color3.fromRGB(20,35,10)},
            Trail={Color3.fromRGB(95,150,35),Color3.fromRGB(185,205,60)},
            Border=Color3.fromRGB(75,105,40),
            Text=Color3.fromRGB(235,245,215),
            Dim=Color3.fromRGB(155,175,130),
            Accent=Color3.fromRGB(185,205,60),
            Hover=Color3.fromRGB(125,170,40)
        },
        Midnight={
            Bg={Color3.fromRGB(12,22,48),Color3.fromRGB(42,62,125)},
            Surface={Color3.fromRGB(10,16,32),Color3.fromRGB(22,34,62)},
            Card={Color3.fromRGB(16,24,45),Color3.fromRGB(32,48,82)},
            Button={Color3.fromRGB(42,58,125),Color3.fromRGB(92,110,210)},
            Track={Color3.fromRGB(6,9,18),Color3.fromRGB(15,23,42)},
            Trail={Color3.fromRGB(55,75,165),Color3.fromRGB(105,125,235)},
            Border=Color3.fromRGB(48,60,96),
            Text=Color3.fromRGB(226,232,240),
            Dim=Color3.fromRGB(145,155,175),
            Accent=Color3.fromRGB(105,125,235),
            Hover=Color3.fromRGB(70,90,180)
        },
        Emerald={
            Bg={Color3.fromRGB(5,42,28),Color3.fromRGB(12,145,98)},
            Surface={Color3.fromRGB(6,28,20),Color3.fromRGB(12,58,42)},
            Card={Color3.fromRGB(10,42,30),Color3.fromRGB(18,78,54)},
            Button={Color3.fromRGB(15,145,95),Color3.fromRGB(90,225,165)},
            Track={Color3.fromRGB(4,14,10),Color3.fromRGB(10,40,28)},
            Trail={Color3.fromRGB(15,165,105),Color3.fromRGB(90,225,165)},
            Border=Color3.fromRGB(25,110,80),
            Text=Color3.fromRGB(225,250,238),
            Dim=Color3.fromRGB(135,175,155),
            Accent=Color3.fromRGB(90,225,165),
            Hover=Color3.fromRGB(20,190,125)
        },
        Sunset={
            Bg={Color3.fromRGB(65,18,8),Color3.fromRGB(165,60,18)},
            Surface={Color3.fromRGB(42,12,8),Color3.fromRGB(78,28,14)},
            Card={Color3.fromRGB(58,18,10),Color3.fromRGB(110,38,18)},
            Button={Color3.fromRGB(225,75,35),Color3.fromRGB(255,180,65)},
            Track={Color3.fromRGB(20,7,4),Color3.fromRGB(48,16,8)},
            Trail={Color3.fromRGB(235,90,35),Color3.fromRGB(255,190,70)},
            Border=Color3.fromRGB(135,60,35),
            Text=Color3.fromRGB(255,242,225),
            Dim=Color3.fromRGB(190,150,125),
            Accent=Color3.fromRGB(255,180,65),
            Hover=Color3.fromRGB(245,110,40)
        },
        Default={
            Bg={Color3.fromRGB(35,35,35),Color3.fromRGB(70,70,70)},
            Surface={Color3.fromRGB(25,25,25),Color3.fromRGB(48,48,48)},
            Card={Color3.fromRGB(35,35,35),Color3.fromRGB(58,58,58)},
            Button={Color3.fromRGB(35,35,35),Color3.fromRGB(65,65,65)},
            Track={Color3.fromRGB(10,10,10),Color3.fromRGB(30,30,30)},
            Trail={Color3.fromRGB(70,70,70),Color3.fromRGB(130,130,130)},
    ...
    local function ApplyThemeObject(obj,theme)
        ...
        elseif role=="Tab" then
            ...
            local colors=active and t.Button or t.Surface
    ...
    local function RefreshTheme()
        -- Reapply every registered object so switching themes never leaves old black surfaces behind.
        ...
        Tab.MouseEnter:Connect(function()
            if Tab.TextTransparency==0 then
                Tab.BackgroundColor3=
                    (Themes[CurrentTheme] or Themes.Gradient).Hover
            end
        end)
