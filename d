...
TabLayout.Padding=UDim.new(0,6)
    ...
    local Themes={
        Gradient={
            Bg={Color3.fromRGB(92,48,155),Color3.fromRGB(215,145,255)},
            Surface={Color3.fromRGB(55,32,82),Color3.fromRGB(105,62,145)},
            Card={Color3.fromRGB(68,40,100),Color3.fromRGB(130,78,165)},
            Button={Color3.fromRGB(125,55,225),Color3.fromRGB(235,145,255)},
            Track={Color3.fromRGB(35,22,52),Color3.fromRGB(72,42,95)},
            Trail={Color3.fromRGB(125,55,225),Color3.fromRGB(235,145,255)},
            Border=Color3.fromRGB(205,150,255),Text=Color3.fromRGB(255,255,255),Dim=Color3.fromRGB(205,190,220),Accent=Color3.fromRGB(245,160,255),Hover=Color3.fromRGB(175,85,245)
        },
        Cyberpunk={
            Bg={Color3.fromRGB(105,15,70),Color3.fromRGB(255,65,175)},
            Surface={Color3.fromRGB(58,18,52),Color3.fromRGB(105,30,82)},
            Card={Color3.fromRGB(72,20,62),Color3.fromRGB(135,38,92)},
            Button={Color3.fromRGB(255,45,165),Color3.fromRGB(40,235,255)},
            Track={Color3.fromRGB(35,12,30),Color3.fromRGB(78,22,58)},
            Trail={Color3.fromRGB(255,45,165),Color3.fromRGB(40,235,255)},
            Border=Color3.fromRGB(255,75,190),Text=Color3.fromRGB(255,255,255),Dim=Color3.fromRGB(220,190,215),Accent=Color3.fromRGB(40,235,255),Hover=Color3.fromRGB(255,80,190)
        },
        Ocean={
            Bg={Color3.fromRGB(15,95,145),Color3.fromRGB(65,225,235)},
            Surface={Color3.fromRGB(15,62,88),Color3.fromRGB(30,125,145)},
            Card={Color3.fromRGB(20,78,105),Color3.fromRGB(40,155,170)},
            Button={Color3.fromRGB(0,155,205),Color3.fromRGB(80,240,225)},
            Track={Color3.fromRGB(8,32,48),Color3.fromRGB(15,78,95)},
            Trail={Color3.fromRGB(0,175,220),Color3.fromRGB(80,240,225)},
            Border=Color3.fromRGB(80,220,230),Text=Color3.fromRGB(245,255,255),Dim=Color3.fromRGB(180,220,225),Accent=Color3.fromRGB(100,245,230),Hover=Color3.fromRGB(20,195,225)
        },
        Rose={
            Bg={Color3.fromRGB(115,20,58),Color3.fromRGB(255,105,165)},
            Surface={Color3.fromRGB(68,20,42),Color3.fromRGB(125,40,72)},
            Card={Color3.fromRGB(82,24,50),Color3.fromRGB(155,52,88)},
            Button={Color3.fromRGB(225,55,125),Color3.fromRGB(255,155,195)},
            Track={Color3.fromRGB(40,12,25),Color3.fromRGB(82,25,45)},
            Trail={Color3.fromRGB(235,65,135),Color3.fromRGB(255,160,200)},
            Border=Color3.fromRGB(255,130,175),Text=Color3.fromRGB(255,250,252),Dim=Color3.fromRGB(225,190,205),Accent=Color3.fromRGB(255,145,190),Hover=Color3.fromRGB(245,85,145)
        },
        Zombie={
            Bg={Color3.fromRGB(35,90,28),Color3.fromRGB(150,205,55)},
            Surface={Color3.fromRGB(28,58,22),Color3.fromRGB(65,105,30)},
            Card={Color3.fromRGB(35,70,24),Color3.fromRGB(85,125,35)},
            Button={Color3.fromRGB(85,155,40),Color3.fromRGB(190,220,70)},
            Track={Color3.fromRGB(15,30,10),Color3.fromRGB(35,62,15)},
            Trail={Color3.fromRGB(105,175,45),Color3.fromRGB(200,225,75)},
            Border=Color3.fromRGB(150,195,65),Text=Color3.fromRGB(245,255,225),Dim=Color3.fromRGB(195,215,160),Accent=Color3.fromRGB(200,225,75),Hover=Color3.fromRGB(125,185,45)
        },
        Midnight={
            Bg={Color3.fromRGB(35,60,125),Color3.fromRGB(105,135,245)},
            Surface={Color3.fromRGB(25,40,78),Color3.fromRGB(52,75,125)},
            Card={Color3.fromRGB(30,48,92),Color3.fromRGB(65,90,145)},
            Button={Color3.fromRGB(65,90,180),Color3.fromRGB(125,150,255)},
            Track={Color3.fromRGB(12,20,40),Color3.fromRGB(28,43,75)},
            Trail={Color3.fromRGB(70,95,205),Color3.fromRGB(130,155,255)},
            Border=Color3.fromRGB(115,140,235),Text=Color3.fromRGB(245,248,255),Dim=Color3.fromRGB(180,190,215),Accent=Color3.fromRGB(135,160,255),Hover=Color3.fromRGB(90,120,220)
        },
        Emerald={
            Bg={Color3.fromRGB(10,95,65),Color3.fromRGB(70,235,175)},
            Surface={Color3.fromRGB(10,62,45),Color3.fromRGB(25,120,82)},
            Card={Color3.fromRGB(14,78,54),Color3.fromRGB(35,155,105)},
            Button={Color3.fromRGB(20,165,105),Color3.fromRGB(100,245,185)},
            Track={Color3.fromRGB(5,30,20),Color3.fromRGB(12,65,42)},
            Trail={Color3.fromRGB(20,185,115),Color3.fromRGB(100,245,185)},
            Border=Color3.fromRGB(75,220,160),Text=Color3.fromRGB(240,255,248),Dim=Color3.fromRGB(175,215,195),Accent=Color3.fromRGB(105,245,185),Hover=Color3.fromRGB(30,205,135)
        },
        Sunset={
            Bg={Color3.fromRGB(120,35,12),Color3.fromRGB(255,155,55)},
            Surface={Color3.fromRGB(70,25,12),Color3.fromRGB(130,48,20)},
            Card={Color3.fromRGB(82,30,14),Color3.fromRGB(165,62,24)},
            Button={Color3.fromRGB(235,80,30),Color3.fromRGB(255,200,85)},
            Track={Color3.fromRGB(38,12,5),Color3.fromRGB(82,27,10)},
            Trail={Color3.fromRGB(245,95,35),Color3.fromRGB(255,205,90)},
            Border=Color3.fromRGB(255,145,60),Text=Color3.fromRGB(255,250,235),Dim=Color3.fromRGB(225,190,155),Accent=Color3.fromRGB(255,195,80),Hover=Color3.fromRGB(250,115,40)
        },
        Default={
            Bg={Color3.fromRGB(55,55,55),Color3.fromRGB(120,120,120)},
            Surface={Color3.fromRGB(42,42,42),Color3.fromRGB(78,78,78)},
            Card={Color3.fromRGB(52,52,52),Color3.fromRGB(92,92,92)},
            Button={Color3.fromRGB(75,75,75),Color3.fromRGB(145,145,145)},
            Track={Color3.fromRGB(22,22,22),Color3.fromRGB(48,48,48)},
            Trail={Color3.fromRGB(90,90,90),Color3.fromRGB(165,165,165)},
            Border=Color3.fromRGB(145,145,145),Text=Color3.fromRGB(255,255,255),Dim=Color3.fromRGB(200,200,200),Accent=Color3.fromRGB(225,225,225),Hover=Color3.fromRGB(105,105,105)
        }
    }
    ...
    local function ApplyThemeObject(obj,theme)
        ...
        elseif role=="Track" then
            obj.BackgroundColor3=t.Track[1]
            g=EnsureGradient(obj)
            if g then g.Color=Sequence(t.Track[1],t.Track[2]) end
